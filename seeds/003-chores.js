    ...
    return knex('chores').truncate()
        .then(function() {
            ...
            return knex('chores').insert([
                ...
                { choreName: 'clean litterbox', choreIcon: "Toilet.png", chorePointValue: 4 }, //6
                { choreName: 'take dog for walk', choreIcon: "Toilet.png", chorePointValue: 4 }, //7
                ...
                { choreName: 'get the newpaper from the dog', choreIcon: '', chorePointValue: 3 }, //16
                { choreName: 'wash the dog(s)', choreIcon: "GardenHose.png", chorePointValue: 5 }, //17
                { choreName: 'wash the cat(s)', choreIcon: "GardenHose.png", chorePointValue: 5 }, //18
                { choreName: `rub grandma's bunions`, choreIcon: '', chorePointValue: 4 }, //19
                { choreName: `trim grandpa's back hair`, choreIcon: '', chorePointValue: 4 }, //20
                ...
                { choreName: 'rake the leaves', choreIcon: "BroomSweeping.png", chorePointValue: 4 }, //24
                { choreName: 'sweep out garage', choreIcon: "BroomSweeping.png", chorePointValue: 3 }, //25
                { choreName: 'feed the dog(s)', choreIcon: '', chorePointValue: 2 }, //26
                { choreName: 'feed the cat(s)', choreIcon: '', chorePointValue: 2 }, //27
                ...
                { choreName: 'mow the yard', choreIcon: '', chorePointValue: 5 }, //36
